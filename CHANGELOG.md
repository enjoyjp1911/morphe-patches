...
* **Force original audio:** Not working in SABR playback ([#2117](https://github.com/enjoyjp1911/morphe-patches/issues/2117)) ([f2f73f3](https://github.com/enjoyjp1911/morphe-patches/commit/f2f73f358f67c69ab20be6e2b55fb4a35c934a0c))
* **Network proxy:** Support HTTPS proxies for auxiliary requests ([#2022](https://github.com/enjoyjp1911/morphe-patches/issues/2022)) ([ee52f90](https://github.com/enjoyjp1911/morphe-patches/commit/ee52f9033687b6022f494f9afba4e0abb1bccba1))
* **Spoof video streams:** Check setting value instead of availability for JavaScript toggles ([1d92650](https://github.com/enjoyjp1911/morphe-patches/commit/1d926503bf9ef29d8e135786479ecef1de20adbc))
* **YouTube - AI channel filter:** Skip list fetch and parse while all toggles are off ([a35a429](https://github.com/enjoyjp1911/morphe-patches/commit/a35a429f971d97c6179af8a76c19c235bf2ca1e8))
* **YouTube - Copy video link:** Copied video link is always shortened ([#1993](https://github.com/enjoyjp1911/morphe-patches/issues/1993)) ([ff0e8cc](https://github.com/enjoyjp1911/morphe-patches/commit/ff0e8ccb935ca3e267c625778ad93f2db213c367))
* **YouTube - Engagement Panel:** Implemented a queue of open panels ([079b23f](https://github.com/enjoyjp1911/morphe-patches/commit/079b23f343f67554b82a8c64457ac2c19d670749))
* **YouTube - FlyoutUtils:** Added compatibility with other video shelf types ([ce7c0b0](https://github.com/enjoyjp1911/morphe-patches/commit/ce7c0b070feaa5de1c865642657a5e00922c9281))
* **YouTube - FlyoutUtils:** Error message when opening Shorts flyout menu ([aaf5f55](https://github.com/enjoyjp1911/morphe-patches/commit/aaf5f55a3a6d769dd850023925725481768e3a15))
* **YouTube - Force original audio track:** Disable setting toggle for Android Creator only ([60ff67b](https://github.com/enjoyjp1911/morphe-patches/commit/60ff67b57cb83fa91cb91135bb7a30afefe0fc94))
* **YouTube - Hide ads:** Hide shopping links in transcripts ([#2025](https://github.com/enjoyjp1911/morphe-patches/issues/2025)) ([0cf389b](https://github.com/enjoyjp1911/morphe-patches/commit/0cf389b921c813961f8b4d3bd12636b84e3f61d1))
* **YouTube - Hide filter bar:** Related videos filter bar is not correctly hidden ([0245d6b](https://github.com/enjoyjp1911/morphe-patches/commit/0245d6bd0b4092a2121e397002f99cd21c22e5f4))
* **YouTube - Hide layout components:** Comment box being hidden on `20.21.37` ([7f77b20](https://github.com/enjoyjp1911/morphe-patches/commit/7f77b20404368279eb216e4911cfe27b9047655e))
* **YouTube - Hide layout components:** Hide all the thumbnails when using "Hide search term thumbnails" ([#2108](https://github.com/enjoyjp1911/morphe-patches/issues/2108)) ([8abb927](https://github.com/enjoyjp1911/morphe-patches/commit/8abb927bec2e9f3c1776b4279f5a2a944586e781))
* **YouTube - Hide layout components:** Hide new type of community post ([35ae5e9](https://github.com/enjoyjp1911/morphe-patches/commit/35ae5e972d353a4119954a7ffcb8fb399980b4fa))
* **YouTube - Hide layout components:** Related videos filter bar not hidden on older versions ([#2086](https://github.com/enjoyjp1911/morphe-patches/issues/2086)) ([21035f7](https://github.com/enjoyjp1911/morphe-patches/commit/21035f77e49f5c58b752b32473ba31fb86125ec4))
* **YouTube - Hide Shorts components:** "Hide video link label" not working on old layouts ([56c8292](https://github.com/enjoyjp1911/morphe-patches/commit/56c82923db252cf242fa2aea8a4722a64ddabd6f))
* **YouTube - Hide Shorts components:** Hide new type of labels ([#2069](https://github.com/enjoyjp1911/morphe-patches/issues/2069)) ([befe786](https://github.com/enjoyjp1911/morphe-patches/commit/befe786470525c7b72a1a357c4539f06496452a8))
* **YouTube - LegacyPlayerControlButton:** Fixed some issues following the add of support for version 21.28.204 ([318d691](https://github.com/enjoyjp1911/morphe-patches/commit/318d691dc0ce31a92c69ac856cad7e0b1d797255))
* **YouTube - Open system share sheet:** Support channelID & commentID fetching ([#1975](https://github.com/enjoyjp1911/morphe-patches/issues/1975)) ([34c2b58](https://github.com/enjoyjp1911/morphe-patches/commit/34c2b58eab29967b1fc784ae0c644297b850ca36))
* **YouTube - Playback speed:** Playback speed is remembered even if the user does not change it manually ([#2134](https://github.com/enjoyjp1911/morphe-patches/issues/2134)) ([b6dbe4f](https://github.com/enjoyjp1911/morphe-patches/commit/b6dbe4f294f124d7b7d84db3360249deda150bf0))
* **YouTube - Playback speed:** Support new native playback speed menu ([#1957](https://github.com/enjoyjp1911/morphe-patches/issues/1957)) ([a4641d6](https://github.com/enjoyjp1911/morphe-patches/commit/a4641d6731170e03b26abc4ecb37230193271673))
* **YouTube - Remember video quality:** Default video quality may not be applied ([#2144](https://github.com/enjoyjp1911/morphe-patches/issues/2144)) ([dcb3cbc](https://github.com/enjoyjp1911/morphe-patches/commit/dcb3cbc798dbaed0739718c529e675e49cbaa764))
* **YouTube - SponsorBlock:** Show segment when 21.28+ auto-hide is off ([bbc171c](https://github.com/enjoyjp1911/morphe-patches/commit/bbc171cc99c2f42390e2fdc1b4cbf1cb1aee5b1e))
* **YouTube - Spoof video streams:** Updated visionOS spoof user agent to support AV1 ([acfafc8](https://github.com/enjoyjp1911/morphe-patches/commit/acfafc82145804a570cdf6e3f2503731ff58ff06))
* **YouTube - StreamOrDetailsDataRequest:** Sometimes player headers is null ([#2035](https://github.com/enjoyjp1911/morphe-patches/issues/2035)) ([c9552c0](https://github.com/enjoyjp1911/morphe-patches/commit/c9552c0eee1415e290218cfe603bb4af98ed0681))
* **YouTube - System share sheet:** Fetch the commentId only when the share button is pressed ([ee8df69](https://github.com/enjoyjp1911/morphe-patches/commit/ee8df69c50c5906d635222fc1e188350eda779a5))
* **YouTube - System share sheet:** Share sheet doesn't works in Shorts ([a8ff805](https://github.com/enjoyjp1911/morphe-patches/commit/a8ff80576bd94561b4a2d631e911a684022c807d))
* **YouTube Music - Downloads:** Hide Premium dialog on external download ([#2009](https://github.com/enjoyjp1911/morphe-patches/issues/2009)) ([4cfe552](https://github.com/enjoyjp1911/morphe-patches/commit/4cfe552daa946c8d4ca946aeffffb63b62ad8370))
* **YouTube Music - Force original audio:** Patch applied to old version where SABR is not enforced ([daa9582](https://github.com/enjoyjp1911/morphe-patches/commit/daa95828950af97c5b3ec898e72f9c537e06daeb))
* **YouTube Music - Remember shuffle state:** Remove conflicting playback controls fingerprint ([f78e195](https://github.com/enjoyjp1911/morphe-patches/commit/f78e19576eb2c81fb9c26143d6ae611f68839b27))
* **YouTube Music - Settings menu filter:** Support version `8.51.51` ([bb733ec](https://github.com/enjoyjp1911/morphe-patches/commit/bb733ec297c5cffb5346cc19100a7accffb1b966))
* **YouTube Music:** Fix 9.15.51 startup ([9e2c372](https://github.com/enjoyjp1911/morphe-patches/commit/9e2c37218aeb601d1d05d66fba4d89255d20c01f))
* **YouTube Music:** Resolve patching experimental app versions ([b6b2b15](https://github.com/enjoyjp1911/morphe-patches/commit/b6b2b15dc63e6a1e6ace7fbfc07cc366d5b25127))
* **YouTube:** Update compatibility version name ([ca4dd01](https://github.com/enjoyjp1911/morphe-patches/commit/ca4dd01fa78bdb921e701cf14267a2d787034d25))

### ✨ New Features

* Add `Settings menu filter` patch ([#2029](https://github.com/enjoyjp1911/morphe-patches/issues/2029)) ([8880421](https://github.com/enjoyjp1911/morphe-patches/commit/88804215819b3de2bd7736047fa0b65e514c58aa))
* Add typed patch options ([#1971](https://github.com/enjoyjp1911/morphe-patches/issues/1971)) ([242318c](https://github.com/enjoyjp1911/morphe-patches/commit/242318c86c842a7bdf2ab364223003637edae20f))
* bump version to 1.36 ([d2fe7ec](https://github.com/enjoyjp1911/morphe-patches/commit/d2fe7ec3242a671031d03dee6766857f95723513))
* **Reddit:** Add `Custom font` patch ([#2100](https://github.com/enjoyjp1911/morphe-patches/issues/2100)) ([b242ad9](https://github.com/enjoyjp1911/morphe-patches/commit/b242ad94ec560ac030f64ce602f3571d2c93a887))
* **Settings:** Long-press a Morphe setting to copy its breadcrumb ([#2130](https://github.com/enjoyjp1911/morphe-patches/issues/2130)) ([622ef54](https://github.com/enjoyjp1911/morphe-patches/commit/622ef54e1dafeb1456ec6fd3616106c2592eca11))
* **Spoof video streams:** Default client maintenance ([#2094](https://github.com/enjoyjp1911/morphe-patches/issues/2094)) ([f321bda](https://github.com/enjoyjp1911/morphe-patches/commit/f321bda0455b1b45334679083066474a77d35442))
* support crossfade for zfold3 ([c2b16ff](https://github.com/enjoyjp1911/morphe-patches/commit/c2b16ff05ab4b133a3abcae6728aa2c3dfae20c0))
* **YouTube - Hide layout components:** Add "AI channel filter" settings ([#1972](https://github.com/enjoyjp1911/morphe-patches/issues/1972)) ([03c0b97](https://github.com/enjoyjp1911/morphe-patches/commit/03c0b97f983a3bbae22bba3a5f51bd2fc09e9a25))
* **YouTube - Hide layout components:** Add "Hide 'Search inside this video' section" setting ([#2097](https://github.com/enjoyjp1911/morphe-patches/issues/2097)) ([e4adb52](https://github.com/enjoyjp1911/morphe-patches/commit/e4adb5278a983248b0da7e1167bc4cc971332cdc))
* **YouTube - Hide layout components:** Add "Hide featured palylists section" setting ([59d7196](https://github.com/enjoyjp1911/morphe-patches/commit/59d7196fa37cc26205c26405eea119ebb3c66cbb))
* **YouTube - Hide layout components:** Add "Hide gift animation and cards" and "Hide gift button" settings ([#1991](https://github.com/enjoyjp1911/morphe-patches/issues/1991)) ([83451d9](https://github.com/enjoyjp1911/morphe-patches/commit/83451d95249b4e951b466c3b7ff8a64b3d7f1a4d))
* **YouTube - Hide layout components:** Add "Hide hashtag section" setting ([95710b1](https://github.com/enjoyjp1911/morphe-patches/commit/95710b18e7a92c02e904c1ba4cc6f0c0aef87ff0))
* **YouTube - Hide layout components:** Add "Hide video thumbnail" setting ([#2043](https://github.com/enjoyjp1911/morphe-patches/issues/2043)) ([360bc41](https://github.com/enjoyjp1911/morphe-patches/commit/360bc412759a8de12ecd31b30f95d199801eea0f))
* **YouTube - Swipe controls:** Add playback speed step preference ([#1977](https://github.com/enjoyjp1911/morphe-patches/issues/1977)) ([25927d1](https://github.com/enjoyjp1911/morphe-patches/commit/25927d12ec5d5a1c0bba570a70ba09fe1e28497c))
* **YouTube Music - Hide ads:** Add "Hide Music Premium promotions" setting ([#2122](https://github.com/enjoyjp1911/morphe-patches/issues/2122)) ([671f24c](https://github.com/enjoyjp1911/morphe-patches/commit/671f24cca071639deb293a740ce3a4bd79e9db3a))
* **YouTube Music:** Add `Disable dislike redirection` patch ([#1962](https://github.com/enjoyjp1911/morphe-patches/issues/1962)) ([e399e05](https://github.com/enjoyjp1911/morphe-patches/commit/e399e05835f40e00a5efb9f311eadbee9be599a9))
* **YouTube Music:** Add `Remember shuffle state` patch ([#1963](https://github.com/enjoyjp1911/morphe-patches/issues/1963)) ([7e8a6ba](https://github.com/enjoyjp1911/morphe-patches/commit/7e8a6babdbafd1dd87ac1397c088f318b89a02da))
* **YouTube Music:** Add `Return YouTube Dislike` patch ([#1994](https://github.com/enjoyjp1911/morphe-patches/issues/1994)) ([8f58725](https://github.com/enjoyjp1911/morphe-patches/commit/8f587259ba8fb4dade3a44eabcdead1948c53945))
* **YouTube Music:** Add `Spoof app version` patch ([#1948](https://github.com/enjoyjp1911/morphe-patches/issues/1948)) ([46a86d3](https://github.com/enjoyjp1911/morphe-patches/commit/46a86d3106e9e00d718e5410ef0c03fb6b228f90))

### 🚀 Updated App Support

* **Reddit:** Add experimental support for `2026.28.0` ([9f18957](https://github.com/enjoyjp1911/morphe-patches/commit/9f18957acd350db0180cb2c66521e8b83b598558))
* **Reddit:** Add experimental support for `2026.29.0` ([e0629fc](https://github.com/enjoyjp1911/morphe-patches/commit/e0629fcdc4edce25db8124d279142bcfd14cb8d8))
* **YouTube Music:** Add experimental support for `9.28.51` ([39e85de](https://github.com/enjoyjp1911/morphe-patches/commit/39e85de5574832e2c282f9dd6e75c1ff3fb5d616))
* **YouTube:** Add experimental support for `21.28.204` ([#2008](https://github.com/enjoyjp1911/morphe-patches/issues/2008)) ([44a0e67](https://github.com/enjoyjp1911/morphe-patches/commit/44a0e67c9c22e6251d0786e031fdb5b16a5b9c13))
* **YouTube:** Add experimental support for `21.29.363` ([#2084](https://github.com/enjoyjp1911/morphe-patches/issues/2084)) ([048880e](https://github.com/enjoyjp1911/morphe-patches/commit/048880e01b868be9280ed2cc295b4dfd42fbe60f))
* **YouTube:** Add support for `21.04.223` ([12e19c0](https://github.com/enjoyjp1911/morphe-patches/commit/12e19c00a143c90b3dd12668a45e07b0cc6dd7a0))
